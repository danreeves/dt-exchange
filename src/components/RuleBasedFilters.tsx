...
export function RuleBasedFilters(props: Props) {
  ...
  return (
    <>
      ...
      <dialog className="help-dialog" ref={dialogRef}>
        <button
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: md.parse(helptext) }}
        />
      </dialog>
    </>
  )
