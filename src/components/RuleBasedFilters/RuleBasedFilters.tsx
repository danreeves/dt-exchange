...
import { DEEMPHASIZE_OPTIONS, DeemphasizeOption } from "../Item/Item"
...
export function RuleBasedFilters(props: Props) {
	...
	function handleFormChange(index: number, event: FormEvent) {
		let data: FormFilterRule[] = [...ruleFields]
	...
	function handleRuleFormSubmit(event: FormEvent) {
